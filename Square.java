...
public class Square {
    ...
    public int findGroup(int number){
        ...
        int grp1[] = {0,1,2,9,10,11,18,19,20}; groups.add(grp1);
        int grp2[] = {3,4,5,12,13,14,21,22,23}; groups.add(grp2);
        int grp3[] = {6,7,8,15,16,17,24,25,26}; groups.add(grp3);
        int grp4[] = {27,28,29,36,37,38,45,46,47}; groups.add(grp4);
        int grp5[] = {30,31,32,39,40,41,48,49,50}; groups.add(grp5);
        int grp6[] = {33,34,35,42,43,44,51,52,53}; groups.add(grp6);
        int grp7[] = {54,55,56,63,64,65,72,73,74}; groups.add(grp7);
        int grp8[] = {57,58,59,66,67,68,75,76,77}; groups.add(grp8);
        int grp9[] = {60,61,62,69,70,71,78,79,80}; groups.add(grp9);
